...
def main():
    ...
    parser.add_argument('-d', '--dataset', default='cifar10', choices=['cifar10', 'cifar100','caltech-101','caltech-256'],
    ...
    parser.add_argument('-t', '--tag',  default='original', help='tag')
    ...
    if exp.is_tl:
        ...
        shutil.copy('train_v1.py', str(exp.logdir) +"/train_v1.py")
        exp.training()
