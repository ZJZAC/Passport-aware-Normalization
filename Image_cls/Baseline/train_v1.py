...
def main():
    ...
    parser.add_argument('--passport-config', default='passport_configs/alexnet_passport.json', help='should be same json file as arch')
    parser.add_argument('--dataset', default='cifar100', choices=['cifar10','cifar100'],
                        help='training dataset (default: cifar10)')
    parser.add_argument('--tl-dataset', default='cifar10', choices=['cifar10','cifar100'],
                        help='transfer learning dataset (default: cifar100)')
    parser.add_argument('--norm-type', default='bn', choices=['bn', 'gn', 'in', 'none'],
                        help='norm type (default: gn)')
    parser.add_argument('--tag',default='all',  help='tag')
