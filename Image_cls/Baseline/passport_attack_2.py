...
def run_attack_2(rep=1, arch='alexnet', dataset='cifar10', scheme=1, loadpath=''):
    ...
    os.makedirs('/data-x/g12/zhangjie/DeepIPR/ori/passport_attack_2', exist_ok=True)
    ...
    for ep in range(1, epochs + 1):
        ...
        torch.save(model.state_dict(),
                   f'/data-x/g12/zhangjie/DeepIPR/ori/passport_attack_2/{arch}-{scheme}-last-{dataset}-{rep}.pth')

    histdf = pd.DataFrame(history)
    histdf.to_csv(f'/data-x/g12/zhangjie/DeepIPR/ori/passport_attack_2/{arch}-{scheme}-history-{dataset}-{rep}.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scheme', default=3, choices=[1, 2, 3], type=int)
    ...
    # args.loadpath="/data-x/g12/zhangjie/DeepIPR/ori/alexnet_cifar10_v2_456-random-gn/2/models/best.pth"
