...
parser.add_argument('--model2', default='pointnet_cls_all_P_bn', help='model name [default: pointnet_cls_ori_bn, pointnet2_cls_ssg]')
...
parser.add_argument('--norm2', type=str, default='P1-BN-AK', help='type of normlization [default: BN, BNCE, GN, GNCE]')
...
def main():
    ...
    pth_dir2 = '/data-x/g12/zhangjie/3dIP/exp/v2/classification/' + args.dataset + "-" \
    ...
    p0 = classifier.fc1.weight
    p1 = classifier2.p1.weight
    print(p0)
    print(p1)
    p0 = p0.flatten()
    p1 = p1.flatten()
